...
public class CoinexchangeRequest {
    ...
    public CoinexchangeRequest(String requestUrl)  throws CoinexchangeApiException {

        this.requestUrl = requestUrl;
        try {
            url = new URL(requestUrl);
        } catch (MalformedURLException e) {
            throw new CoinexchangeApiException("Mailformed URL " + e.getMessage());
        }
     ...
     */
    public CoinexchangeRequest post() {
        this.setMethod("POST");
        return this;
    }
     ...
     * @return this request object
     */
    public CoinexchangeRequest put() {
        this.setMethod("PUT");
        return this;
    }
     ...
     * @return this request object
     */
    public CoinexchangeRequest delete() {
     ...
     */
    public CoinexchangeRequest connect() throws CoinexchangeApiException {
        ...
        try {
            ...
            throw new CoinexchangeApiException("SSL Error " + e.getMessage() );
        } catch (KeyManagementException e) {
            throw new CoinexchangeApiException("Key Management Error " + e.getMessage() );
        }

        try {
            conn = (HttpsURLConnection)url.openConnection();
        } catch (IOException e) {
            throw new CoinexchangeApiException("HTTPS Connection error " + e.getMessage());
        }

        try {
            conn.setRequestMethod(method);
        } catch (ProtocolException e) {
            throw new CoinexchangeApiException("HTTP method error " + e.getMessage());
        }
     ...
     * @throws CoinexchangeApiException in case of any error
     */
    public CoinexchangeRequest read() throws CoinexchangeApiException {
        if (conn == null) {
            connect();
        }
        try {
            ...
            if (conn.getResponseCode() >= HttpURLConnection.HTTP_BAD_REQUEST) {
                ...
                if (obj.has("code") && obj.has("msg")) {
                    throw new CoinexchangeApiException("ERROR: " +
                            obj.get("code").getAsString() + ", " + obj.get("msg").getAsString() );
                }
            }
        } catch (IOException e) {
            throw new CoinexchangeApiException("Error in reading response " + e.getMessage());
        }
        return this;
    }

    public CoinexchangeRequest payload(JsonObject payload) {
